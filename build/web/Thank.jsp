<%-- 
    Document   : Thank
    Created on : Mar 6, 2022, 10:07:45 PM
    Author     : PC
--%>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="block text-center">
                            ...
                            <p>Order successfully, Thank you so much...</p>
                            <a href="ControllerProduct" class="btn btn-main mt-20">Continue Shopping</a>
                        </div>
                    </div>
                </div>
            </div>
