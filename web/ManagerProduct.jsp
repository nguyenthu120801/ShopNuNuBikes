            ...
            <div class="row">
                <div class="col-lg-3 title " >
                    ...
                    <ul class="list-group text-center" style="max-width: 80%; margin-left: 15px">
                        ...
                        <li class="list-group-item" style="margin-left: 5%;background-color: #1bbb1b"><a href="ProductSevlet?s=displayAllProduct">Product Manager</a></li>
                        <li class="list-group-item" style="margin-left: 5%"><a href="BillServlet?s=Bill">Bill Manager</a></li>
                    </ul>
                    <div style="margin-left: 35px">
                        <div>
                            <form style="margin-top: 12px;" action="ProductSevlet">
                                <input type="hidden" name="s" value="searchProductbyName">
                                <input type="search" placeholder="Search" name="nameP"/>
                        ...
                        <div>
                            <form style="margin-top: 12px;" action="ProductSevlet">
                                <input type="hidden" name="s" value="searchProductbyPrice">
                                FROM: <input type="search" placeholder="price" name="from" style="max-width: 60px"/>
                                TO: <input type="search" placeholder="price" name="to" style="max-width: 60px"/>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-success" href="ProductSevlet?s=updateProduct&productID=<%=p.getProductID()%>">update</a></td> 
                                <td><a class="btn btn-danger" href="ProductSevlet?s=deleteProduct&productID=<%=p.getProductID()%>">Delete</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
